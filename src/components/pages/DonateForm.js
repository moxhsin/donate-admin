...
const Progress = styled.div`
  ...
  height: 100%;
  background-color: rgb(24, 65, 45); // Set to red color as requested
`;
            ...
            {isLoading ? (
                ...
                <Row>
                    <Col size="md-6 sm-12">
                        {donateForm.length ? (
                            <div>
                                <h1 style={{ fontWeight: "900", textAlign: "center", margin: "110px 0px 20px", fontFamily: Theme.fontPrimary, color: 'rgb(24, 65, 45)' }}>
